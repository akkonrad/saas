// @ts-expect-error import from https
...
function validateContactForm(
  data: unknown,
): { valid: true; data: ContactFormRequest } | { valid: false; error: string } {
...
serve(async (req) => {
  ...
  try {
    ...
    // @ts-expect-error Deno not defined locally
    ...
    const validation: any = validateContactForm(body);
